...
### Relevant: Suppl. Fig.6 b (single-region clustering analysis, selectivity space, varying delta R2 threshold)
###     One can vary delta_R2_thres in line 26.
###########################################################################
...
#   1. whose R2 pass the minimum \Delta R2 threshold (try 0.0, 0.01 and 0.02)
...
res_folder = f"./results_supplfig6/selectivity_space/deltaR2thres{delta_R2_thres}" # folder to save the clustering analysis results
...
ax.set_ylabel(r"Silhouette Score (z, $\Delta R^2$=%.2f)" % delta_R2_thres)
