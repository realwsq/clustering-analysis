...
### Relevant: Suppl. Fig.6 b (single-region clustering analysis, selectivity space, varying clustering algorithm)
###########################################################################
...
algo_kwargs = {"min_N": 50, 
               "algo": "leiden", "n_neighbor_list":range(3,100), 
               "dis_metric": "euclidean"}
res_folder = f"./results_supplfig6/selectivity_space/leiden" # folder to save the clustering analysis results
...
ax.set_ylabel("Silhouette Score (z, Leiden Algorithm)")
